    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
          <p className="text-black bg-white rounded-2xl text-[15px] px-4 py-1 hidden md:block cursor-pointer">
            Explore Premium
          </p>
          ...
          <img className="flex w-4 h-4 cursor-pointer" src={assets.bell_icon} alt="" />
        </div>
      </div>
